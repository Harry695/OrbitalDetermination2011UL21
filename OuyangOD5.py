...
# print("Test case 1", getFAndGConstants(tau1, tau3, r2, r2dot))
...
# print("Test case 2", getFAndGConstants(tau1, tau3, r2, r2dot))
...
print("Test case 3", getFAndGConstants(tau1, tau3, r2, r2dot))